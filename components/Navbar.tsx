  ...
  return (
    <main className="shadow-md px-10 py-3 flex items-center justify-between sticky top-0 bg-white">
      ...
      <button
        ...
        className="text-xl lg:hidden z-50"
      >
      ...
      {/* mobile and tab view */}
      <div
        className={` min-h-dvh bg-white w-full absolute top-0 right-0 lg:hidden ${navOpen ? "flex" : "hidden"}  flex-col pt-20 items-center gap-10 `}
      >
        {navItems.map((item, i) => (
          <Link
