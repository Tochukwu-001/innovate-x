...
export default function Home() {
  return (
    <>
      <main className="min-h-dvh bg-[url('/bg-image.jpg')] bg-cover bg-center bg-no-repeat z-20">
        <section className="min-h-dvh bg-black/40 z-20 p-3 flex items-center justify-center">
          <div className="text-white lg:w-1/2 mx-auto flex flex-col gap-10 items-center justify-center max-md:pt-10">
            ...
            <p className="text-xl font-light text-center">is a digital platform built to amplify innovative African minds by providing a space to share ideas, insights and solutions that address real challenges across the continent. It connects thinkers, creators and problem-solvers who are passionate about driving sustainable growth, collaboration, and positive impact in Africa through innovation and technology.</p>
