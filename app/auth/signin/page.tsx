    ...
    return(
        <main className="min-h-dvh grid lg:grid-cols-2">
            ...
            <div className="flex items-center flex-col w-full max-lg:p-3">
                <h1 className="text-gray-800 my-10 text-2xl text-center font-semibold">Create Your Account</h1>
                <section className="lg:w-1/2 flex flex-col gap-5 max-md:w-full">
                    <div className="w-full flex flex-col">
                        <input type="email" className="border outline-none border-gray-300 p-2 rounded-md" placeholder="example@gmail.com"/>
                        <button className="bg-sky-600 text-white p-2 rounded-md mt-2">Sign In</button>
                    </div>
